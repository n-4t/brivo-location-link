...
# Usage
Unlocks the nearest of 10 doors/gates/elevators to your current location in one click. Can open up to 4 doors simultaneously

# Setup
1. Go to Settings -> Apps -> Special app access -> **Install unknown apps** (this is the path for google pixel phones, if you have a samsung or anything else probably just google it)
...
notes:
  - Brivo Mobile Pass app must already be installed, and you must be currently logged in
  - door coordinates are hard-coded and specific to the building
